...
<template>
  <li
    class="[ venue-exhibition-record ] group/venue-record relative border-t border-archive-rule-ledger/24 transition-colors duration-240 last:border-b last:border-archive-rule-ledger/24 motion-reduce:transition-none"
