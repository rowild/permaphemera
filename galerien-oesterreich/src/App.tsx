...
export default function GalleryDashboard() {
  ...
  return <main id="top">
    <header className="site-header"><a className="wordmark" href="#top" aria-label="Zum Seitenanfang">G<span>Ö</span></a><nav aria-label="Hauptnavigation"><a href="#statistik">Zahlen</a><a href="#karte">Karte</a><a href="#verzeichnis">Verzeichnis</a></nav><div className="status-pill"><i />Datenstand 25.08.2026</div></header>
