...
<template>
  ...
  >
    ...
    <span
      class="[ archive-text-link-label ] relative pb-[0.08em] after:absolute after:right-0 after:bottom-[-0.12em] after:left-0 after:h-px after:origin-center after:scale-x-90 after:content-[''] after:transition-[background-color,opacity,transform] after:duration-200 after:ease-out group-hover/archive-text-link:after:scale-x-100 group-focus-visible/archive-text-link:after:scale-x-100 motion-reduce:after:transition-none"
