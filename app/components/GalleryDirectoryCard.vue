...
const imageTransform = computed(() => createDirectoryImageTransform(props.location.id))
const ornament = computed(() => createOrnamentTransform(`gallery-directory:${props.location.id}`, props.featured))
...
const sequence = computed(() => props.location.archive_number || String(props.index + 1).padStart(2, '0'))
</script>
